      ...
      <View style={styles.headerContainer}>
        ...
        <View style={styles.contentContainer}>
          ...
          {/* <View>
            ...
            <Text>Snap Percentage: {opportunity.snapPercentage}%</Text>
            <Text>Receptions: {opportunity.receptions}</Text>
            <Text>Targets: {opportunity.targets}</Text>
            <Text>Targets Rank: {opportunity.targetsRank}</Text>
            <Text>Targets Percentile: {opportunity.targetsPercentile}%</Text>
          </View> */}
